...
@Query(value = "select campaign_id , SUM(total) as total,SUM(delivered) as delivered, SUM(inProcess) as inProcess, SUM(failed) as failed\n" +
        "from\n" +
        "\t(\n" +
        "\t\tselect campaign_id , count(*)  as total, (select 0) as failed, (select 0) as delivered, (select 0) as inProcess\n" +
        "\t\tfrom campaign_task ct \n" +
        "\t\twhere ct.PARENT_ID  is null \n" +
        "\t\tand (campaign_id = ?1 or ?1 = ' ' or ?1 = null)\n" +
//                "\t\tand (route_id = 'grameenphone')\n" +
        ...
        "\t\tunion all\n" +
        "\t\tselect campaign_id , (select 0)  as total, (select 0) as failed, count(*) as delivered, (select 0) as inProcess\n" +
        "\t\tfrom campaign_task ct \n" +
        "\t\twhere ct.PARENT_ID  is null\n" +
        "\t\tand (campaign_id = ?1 or ?1 = ' ' or ?1 = null)\n" +
//                "\t\tand (route_id = 'grameenphone')\n" +
        ...
        "\t\tunion all\n" +
        "\t\tselect campaign_id , (select 0)  as total,(select 0) as failed, (select 0) as delivered, count(*) as inProcess\n" +
        "\t\tfrom campaign_task ct \n" +
        "\t\twhere ct.PARENT_ID  is null\n" +
        "\t\tand (campaign_id = ?1  or ?1 = ' ' or ?1 = null)\n" +
//                "\t\tand (route_id = 'grameenphone')\n" +
        ...
        "\t\tgroup by ct.campaign_id #inprocess\n" +
        "\t\tunion all\n" +
        "\t\tselect campaign_id , (select 0)  as total,count(*) as failed, (select 0) as delivered,(select 0) as inProcess\n" +
        "\t\tfrom campaign_task ct \n" +
        "\t\twhere ct.PARENT_ID  is null\n" +
        "\t\tand (campaign_id = ?1 or ?1 = ' ' or ?1 = null)\n" +
//                "\t\tand (route_id = 'grameenphone')\n" +
        ...
        nativeQuery = true)
List<Object[]> campaignWise(String campaignId);
